...
<div class="panel admin-panel">
		<div class="panel-head"><strong class="icon-reorder"> 联系人员列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
	<div class="padding border-bottom">
		<form method="post" action="searchClientByCondition.do"
			...
			<ul class="search" style="padding-left:10px;">
				<li> <a class="button border-main icon-plus-square-o" href="addClientBefore.do"> 添加联络人员</a> </li>
				<li>
					<select name="selectSearchType" id="selectSearchType" class="input" style="width:200px; line-height:17px;" onchange="setSearchType();">
						...
						%>
						<option value="clientName">联络人员姓名</option>
						<option value="operatorName">联络人员手机号码</option>
						<%
							}
						%>
						<%
