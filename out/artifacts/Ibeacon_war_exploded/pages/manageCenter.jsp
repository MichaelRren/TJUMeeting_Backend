...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li id="item_1" style="visibility:hidden"><a href="searchDevice.do?userId=<%=rb.getUserId()%>&page=1&roleName=<%=rb.getRoleName()%>" target="right"><span class="icon-caret-right"></span>宾客信息管理</a></li>
    <li id="item_2" style="visibility:hidden"><a href="searchClient.do?userId=<%=rb.getUserId()%>&page=1&roleName=<%=rb.getRoleName()%>" target="right"><span class="icon-caret-right"></span>联络人员管理</a></li>
    <li id="item_3" style="visibility:hidden"><a href="searchOperator.do?userId=<%=rb.getUserId()%>&page=1&roleName=<%=rb.getRoleName()%>" target="right"><span class="icon-caret-right"></span>签到信息管理</a></li>
  </ul>   
</div>
