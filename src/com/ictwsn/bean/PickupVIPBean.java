 ...
 * 司机和VIP结合的bean
 */
public class PickupVIPBean {
    private String userNumber; //用户手机号
    private String userName; //用户姓名
    private String userRole;  //角色
    private String workerNumber;  //随行人员手机号
    private String workPlace;
    private String arrivalDate;
    private String arrivalNumber;  //到达车次
    private String arrivalStation;
    private String hname; //酒店名称
    private String htype; //房型
    private String remark; //备注
    private String dnumber;  //司机手机号
