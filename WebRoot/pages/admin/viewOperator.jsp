...
<body faiscoMobi="true" id="g_body" class="g_locale2052 mobiCol3">
	...
	<div id="g_web" class="g_web">
		...
		<div class='loginHeader webHeaderBg'>
			<a
				href='searchOperator.do?userId=<%=rb.getUserId()%>&page=${page}&roleName=<%=rb.getRoleName()%>'
				class='g_close icon-gClose'></a><span class='title pageTitle'>查询运营商用户			
		</div>
							...
							<div class='formMiddleContent formMiddleContent9 moduleContent'
								...
								<div id='signupPage'>
									...
									<div class='signUpContent'>
										<div id='profileArea'>
											<form id="updateOperatorForm" name="updateOperatorForm"
												action="updateOperator.do" method="post">
												<div class='g_globalLine '>
													<input type='text' maxlength='50' name='operatorName'
														id='operatorName'
														class='mustItem itemEdit userAddItem g_input'
														readonly="readonly" value="${ob.name}"><span
												...
												<div class='g_globalLine '>
													<input type='text'
														class='mustItem itemEdit userAddItem g_input'
														id='operatorPassword' name='operatorPassword' maxlength='50'
														readonly="readonly" value="${ob.password}"><span
												...
												<div class='g_globalLine '>
													<input type='text'
														...
														name='operatorUuid' maxlength='50' readonly="readonly" value="${ob.uuid}"><span
												...
												<div class='g_globalLine '>
													<input type='text'
														...
														name='operatorMajor' maxlength='50' readonly="readonly" value="${ob.major}"><span
												...
												<div class='g_globalLine '>
													<input type='text'
														class='mustItem itemEdit userAddItem g_input'
														id='operatorPhone' name='operatorPhone' maxlength='50'
														readonly="readonly" value="${ob.phone}"><span
												...
												<div class='g_globalLine '>
													<input type='text' maxlength='50' id='operatorAddress'
														...
														class='mustItem itemEdit userAddItem g_input'
														readonly="readonly" value="${ob.address}"><span
