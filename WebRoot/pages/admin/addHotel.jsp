    ...
    <form action="" method="post" class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input w50" value="" maxlength="50" placeholder="请输入酒店名称(必填)" id="hname" name="hname">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input w50" value="" maxlength="100" placeholder="请输入酒店地址(必填)" id="hurl" name="hurl">
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button onClick="addHotel();" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i>确认添加</button>
...
<script type="text/javascript">
    function addHotel(){
        ...
        if(hurl==""){
            ...
            return 0;
        }else if(hurl.length > 100)
        {
            document.getElementById("h_url").innerHTML="*地址最多输入100个字!";
            document.getElementById("hurl").focus();

            return 0;
        }
        document.getElementById("hurl").innerHTML="";
        ...
        $.post("addHotel.do", {
            ...
            function(data) {
                if (data == 1) {
                    Showbo.Msg.alert("酒店添加成功!",function(){window.location='viewHotel.do?page=1';});

                } else {
                    Showbo.Msg.alert("酒店添加失败!");
                }
            });
    }
