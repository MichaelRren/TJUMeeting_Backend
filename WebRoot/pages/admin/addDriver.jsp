    ...
    <form action="" method="post" class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input w50" value="" maxlength='20' placeholder="请输入司机姓名(必填)" id="dname" name="dname">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input w50" value="" maxlength="11" minlength="11" placeholder="请输入司机手机号码(必填)" id="dnumber" name="dnumber">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input w50" value="" maxlength='20' placeholder="请输入车牌(必填)" id="dplate" name="dplate">
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button onClick="addDriver();" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i>确认添加</button>
...
<script type="text/javascript">
    function addDriver(){
        ...
        if(dplate==""){
            document.getElementById("d_plate").innerHTML="*请输入牌照!";
        ...
        $.post("addDriver.do", {
            ...
            function(data) {
                if (data == 1) {
                    Showbo.Msg.alert("司机添加成功!",function(){window.location='viewDriver.do?page=1';});

                } else {
                    Showbo.Msg.alert("司机添加失败!");
                }
            });
    }
